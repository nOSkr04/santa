...
дээрх ашигладаг утасны дугаар нь тус хүнийг өөрийг нь гэдгийг нотлох гол шалгуур болно.        
        ...
        <li className="ml-50 mt-3">
        3. Хэрэглэгчийн бүртгэлийг хялбар байлгах систем ажиллаж байгаа тул хэрэглэгчийн
        хайхрамжгүй байдлаас үүдэн утасны дугаараа буруу оруулах болон пин кодоо мартсан
        зэрэгтэй асуудлуудад Santa.mn хариуцлага хүлээхгүй болно.        
        </li>
        <li className="ml-50 mt-3">
        ...
        <li className="ml-50 mt-3">
        2. Бэлэг түгээх үйл ажиллагаа 2024.01.01-ний өдрийн шөнийн 01:00 цагт нийгмийн
...
эрх байна.
        ...
        <li className="ml-50 mt-3">
        5. Бэлэг түгээх үйл ажиллагаа нь тооцоолсноос алдагдалтай нөхцөл байдлыг бий болгосон
тохиолдолд бэлгийн тоо ширхэг багасах эсвэл өндөг худалдан авсан төлбөрийг буцаан
шилжүүлэх үйл ажиллагаа зохион байгуулагдана. Хэрэглэгч үүнд бодитойгоор хандаж
шийдвэрийг хүндэтгэн хүлээн авах үүрэгтэй.
        </li>
      </div>
        <p>&nbsp;</p>`
  };
